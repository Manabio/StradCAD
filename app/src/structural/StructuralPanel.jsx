...
export const StructuralPanel = observer(function StructuralPanel({ project, graph, composition, onClose, isLandscape, focusRequest, onToast, onStructureChanged, onSelectMembers }) {
  ...
  const inner = (
    <>
      ...
      {activeTab === 'common'
        ...
        : <MemberListTab composition={composition} project={project} focusRequest={focusRequest} onToast={onToast} onStructureChanged={onStructureChanged} onSelectMembers={onSelectMembers} />}
    </>
  );
