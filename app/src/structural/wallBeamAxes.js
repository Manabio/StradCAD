...
// **追従先（新座標）に既に通り芯・別の梁芯（重複ガード。findBeamAnchorCL）があれば
// （案B・ユーザー裁定・2026-09-26）**: 移動元の梁芯（旧）が保護されなければ
// （isProtectedWallBeamAxis。道連れ削除・昇格時の梁芯吸収と共通の述語）吸収して撤去する——
// 相手はどちらの種別でも動かさず残す（相手が既にその座標の壁の根拠を持っているため）。
