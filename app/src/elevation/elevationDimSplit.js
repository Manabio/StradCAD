 ...
 * @param {object} graph
 * @param {{floorSegments?:Array<{hiX:number, hiCLId:?string}>, boundary:{lo:number, hi:number}}} opts
 * @returns {number[]}
 */
export function collectRow1SplitPoints(face, graph, { floorSegments, boundary }) {
